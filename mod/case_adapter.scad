...
module case_adapter(case_design) {
  ...
  mb_adapters = [
    [
      ...
      ["left_middle", 6.35, 165.1],
      ["middle_middle", 163.83, 165.1],
      ["right_middle", 288.29, 165.1],
      ["middle_middle2", 209.55, 237.49],
      ["right_middle2", 288.29, 237.49],
      ["left_front", 6.35, 322.58],
      ["middle_front", 163.83, 322.58],
    ...
    [
      ...
      ["middle_middle", 163.83, 165.1],
      ["right_middle", 288.29, 165.1],
      ["middle_front", 209.55, 237.49],
      ["right_front", 288.29, 237.49],
    ],
    [
      "adapter_atx",
      304.8,
      ...
      ["left_rear", 6.35, 33.02],
      ["middle_rear", 163.83, 10.16],
      ["middle2_rear", 211.99, 10.16],
      ["right_rear", 288.29, 10.16],
      ["left_middle", 6.35, 165.1],
      ["middle_middle", 163.83, 165.1],
      ["right_middle", 288.29, 165.1],
      ["left_front", 6.35, 237.49],
      ["middle_front", 163.83, 237.49],
      ["right_front", 288.29, 237.49],
    ],
    [
      "adapter_micro-atx",
      ...
      ["left_rear", 6.35, 33.02],
      ["middle_rear", 163.83, 10.16],
      ["right_rear", 211.99, 10.16],
      ["left_middle", 6.35, 165.1],
      ["middle_middle", 163.83, 165.1],
      ["middle2_middle", 209.55, 165.1],
      ["right_middle", 229.87, 165.1],
      ["left_front", 6.35, 237.49],
      ["right_front", 163.83, 237.49],
    ],
    [
      "adapter_dtx",
      230.2,
    ...
    [
      ...
      ["middle_rear", 163.83, 10.16],
      ["right_rear", 211.99, 10.16],
      ["left_front", 6.35, 165.1],
      ["middle_front", 163.83, 165.1],
    ...
    [
      ...
      170.18,
      ["left_rear", 6.35, 33.02],
      ["right_rear", 163.83, 10.16],
      ["left_front", 6.35, 165.1],
      ["right_front", 163.83, 165.1],
    ],
    [
      "adapter_mini-itx",
      170,
    ...
    union() {
      difference() {
        ...
        if (sbc_bottom_standoffs == true) {
          for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
            ...
            if (
              class == "pcbhole" && id == pcb_id && pcbhole_pos == "left_rear" && bottom_rear_left_enable == true && bottom_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, -1]) cylinder(d=bottom_standoff[4] - .2, h=bottom_height);
            }
            if (
              class == "pcbhole" && id == pcb_id && pcbhole_pos == "left_front" && bottom_front_left_enable == true && bottom_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, -1]) cylinder(d=bottom_standoff[4] - .2, h=bottom_height);
            }
            if (
              class == "pcbhole" && id == pcb_id && pcbhole_pos == "right_rear" && bottom_rear_right_enable == true && bottom_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, -1]) cylinder(d=bottom_standoff[4] - .2, h=bottom_height);
            }
            if (
              class == "pcbhole" && id == pcb_id && pcbhole_pos == "right_front" && bottom_front_right_enable == true && bottom_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, -1]) cylinder(d=bottom_standoff[4] - .2, h=bottom_height);
            }
          }
      ...
      if (sbc_bottom_standoffs == true) {
        for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
          ...
          if (
            class == "pcbhole" && id == pcb_id && (pcbhole_pos == "left_rear" || pcbhole_pos == "left_front" || pcbhole_pos == "right_rear" || pcbhole_pos == "right_front")
          ) {
