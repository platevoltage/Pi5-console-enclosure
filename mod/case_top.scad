  ...
  difference() {
    union() {
      difference() {
        union() {
          if (case_design == "shell") {
            difference() {
              ...
              translate(
                ...
                cube_fillet_inside(
                  [width - (wallthick * 2), depth - (wallthick * 2), top_height],
          ...
          if (case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
            ...
            translate(
              [
                -wallthick - gap + .5,
                -wallthick - gap,
                case_z - floorthick + adj,
              ]
            ) cube([width - 1, wallthick, wallthick]);
          }
          if (case_design == "tray") {
            difference() {
              translate([(width / 2) - wallthick - gap, (depth / 2) - wallthick - gap, case_z / 2])
                cube_fillet_inside(
                  [width + 2 * wallthick + 1, depth, case_z],
              ...
              translate([(width / 2) - wallthick - gap, (depth / 2) - wallthick - gap, (case_z / 2) - floorthick + .25])
                cube_fillet_inside(
                  [width + 1, depth + (wallthick * 2), case_z],
                  vertical=[
              ...
              for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
                ...
                if (class == "pcbhole" && id == pcb_id && pcbhole_pos == "left_rear") {
                  if (
                    (pcbhole_y <= 10 && pcbhole_x <= 10) || (
                      ext_top_standoffs == true && ext_top_rear_left_enable == true
                    )
                  ) {
                ...
                if (class == "pcbhole" && id == pcb_id && pcbhole_pos == "left_front") {
                  if (
                    (pcbhole_y >= pcb_depth + case_offset_y - 10 && pcbhole_x <= 10) || (ext_top_standoffs == true && ext_top_front_left_enable == true)
                  ) {
                    translate(
                      [
                        -wallthick - gap - adj - 6,
                ...
                if (class == "pcbhole" && id == pcb_id && pcbhole_pos == "right_rear") {
                  if (
                    (pcbhole_y <= 10 && pcbhole_x >= pcb_width - 10) || (
                      ext_top_standoffs == true && ext_top_rear_right_enable == true
                    )
                  ) {
          ...
          if (case_design == "round") {
            difference() {
              translate([pcb_width / 2, pcb_depth / 2, bottom_height + (top_height / 2) - lip / 2]) rotate([0, 0, 30])
                  cylinder_fillet_inside(
                    h=top_height + lip, r=case_diameter / 2,
              ...
              translate([pcb_width / 2, pcb_depth / 2, bottom_height + (top_height / 2) - floorthick - lip / 2]) rotate([0, 0, 30])
                  cylinder_fillet_inside(
                    h=top_height + lip, r=(case_diameter / 2) - wallthick,
              ...
              translate([pcb_width / 2, pcb_depth / 2, bottom_height - adj - lip / 2]) rotate([0, 0, 30])
                  cylinder_fillet_inside(
                    h=lip + 2 * adj, r=(case_diameter / 2) - wallthick / 2 + tol / 2,
                    top=edge_fillet - 1, bottom=0, $fn=case_fn, fillet_fn=case_ffn, center=true
                  );
              // io cutout
              if (
                ...
                translate([width, (depth / 2) - wallthick - gap, bottom_height - lip + top_height / 2 - floorthick])
                  cube_fillet_inside(
                    [18, depth - 2 * (wallthick + gap) - 1, top_height + lip + 2],
                ...
                translate([(width / 2) - wallthick - gap, -20, bottom_height - lip + top_height / 2 - floorthick])
                  cube_fillet_inside(
                    [width - 2 * (wallthick + gap) - 1, 40, top_height + lip + 2],
                    vertical=[0, 0, 0, 0], top=[0, 0, 0, 0], bottom=[0, 0, 0, 0], $fn=90
                  );
              }
            }
            if (
              ...
              translate(
                [
                  width - 2 * wallthick - gap - .95,
                  depth / 2 - wallthick - gap - (depth - 2 * (floorthick + gap)) / 2,
                  bottom_height,
                ]
              ) cube([wallthick - adj, depth - 2 * (floorthick + gap), top_height + adj]);
            } else {
              translate(
                [
                  -.95,
                  depth / 2 - 2 * wallthick - gap - (depth - 2 * (floorthick + gap)) / 2,
                  bottom_height,
                ]
              ) cube([width - 2 * (floorthick + gap), wallthick - adj, top_height + adj]);
            }
          }
          if (case_design == "hex") {
            if (
            ...
            if (
              ...
              translate(
                [
                  0,
                  depth / 2 - 2.25 * (wallthick + gap) - (depth - 2 * (floorthick + gap)) / 2,
                  bottom_height,
                ]
              ) cube([width - 2 * (floorthick + gap), wallthick - adj, top_height + adj]);
            }
          ...
          if (case_design == "snap") {
            ...
            difference() {
              translate([(width / 2) - wallthick - gap, (depth / 2) - wallthick - gap, case_z - adj])
                cube_fillet_inside(
                  [width - 2 * wallthick - tol, depth - 2 * wallthick - tol, 2 * floorthick + 1.5],
                  vertical=[corner_fillet, corner_fillet, corner_fillet, corner_fillet],
                  top=[0, 0, 0, 0], bottom=[edge_fillet, edge_fillet, edge_fillet, edge_fillet, edge_fillet], $fn=90
                );
              ...
              translate([(width / 2) - wallthick - gap, (depth / 2) - wallthick - gap, case_z - adj])
                cube_fillet_inside(
                  [width - (3 * wallthick), depth - (3 * wallthick), 2 * floorthick + 1.5 + adj],
                  vertical=[
                    corner_fillet - wallthick,
                    corner_fillet - wallthick,
                    corner_fillet - wallthick,
            ...
            difference() {
              ...
              translate(
                [
                  width - wallthick - gap - 8.5,
                  (depth / 2) - ( (depth * .75) / 2) + 1.25 - gap - wallthick,
                  case_z + floorthick - 5.75,
                ]
              ) cube([6, (depth * .75) - 2, 6]);
            }
          }
            ...
            difference() {
              translate(
                [
                  (width / 2) - wallthick - gap,
                  (depth / 2) - wallthick - gap,
                  case_z + floorthick / 2 - (lip) / 2,
                ]
              )
                cube_fillet_inside(
                  [width, depth, lip + floorthick],
                  vertical=[corner_fillet, corner_fillet, corner_fillet, corner_fillet],
                  top=[edge_fillet, edge_fillet, edge_fillet, edge_fillet, edge_fillet],
                  bottom=[0, 0, 0, 0], $fn=90
                );
              translate([(width / 2) - wallthick - gap, (depth / 2) - wallthick - gap, case_z - floorthick - 1])
                cube_fillet_inside(
                  [width - wallthick + tol, depth - wallthick + tol, lip + floorthick],
                  vertical=[corner_fillet - wallthick, corner_fillet - wallthick, corner_fillet - wallthick, corner_fillet - wallthick],
                  top=[edge_fillet, edge_fillet, edge_fillet, edge_fillet, edge_fillet],
                  bottom=[0, 0, 0, 0], $fn=90
                );
        ...
        if (sbc_top_standoffs == true) {
          for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
            ...
            pcbhole_pos = sbc_data[s[0]][i + 10][4];
            case_z =
              case_design == "fitted" || case_design == "tray_sides" || case_design == "tray_vu5" || case_design == "tray_vu7" ? case_z + floorthick
              : case_design == "snap" ? case_z + (2 * floorthick)
              : case_design == "panel_nas" ? case_z - floorthick : case_z;

            if (
              class == "pcbhole" && id == 0 && pcbhole_pos == "left_rear" && top_rear_left_enable == true && top_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                cylinder(d=top_standoff[4] - .2, h=floorthick + (2 * adj));
            }
            if (
              class == "pcbhole" && id == 0 && pcbhole_pos == "left_front" && top_front_left_enable == true && top_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                cylinder(d=top_standoff[4] - .2, h=floorthick + (2 * adj));
            }
            if (
              class == "pcbhole" && id == 0 && pcbhole_pos == "right_rear" && top_rear_right_enable == true && top_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                cylinder(d=top_standoff[4] - .2, h=floorthick + (2 * adj));
            }
            if (
              class == "pcbhole" && id == 0 && pcbhole_pos == "right_front" && top_front_right_enable == true && top_standoff[6] != "blind"
            ) {
              translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                cylinder(d=top_standoff[4] - .2, h=floorthick + (2 * adj));
            }
            ...
            if (class == "pcb") {
              for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
                ...
                if (id == pcbid && id != 0 && pcbclass == "pcbhole") {
                  if (
                    pcbclass == "pcbhole" && pcbhole_pos == "left_rear" && multipcb_top_rear_left_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                  ) {
                    translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                      cylinder(d=multipcb_top_standoff[4] - .2, h=floorthick + (2 * adj));
                  }
                  if (
                    pcbclass == "pcbhole" && pcbhole_pos == "left_front" && multipcb_top_front_left_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                  ) {
                    translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                      cylinder(d=multipcb_top_standoff[4] - .2, h=floorthick + (2 * adj));
                  }
                  if (
                    pcbclass == "pcbhole" && pcbhole_pos == "right_rear" && multipcb_top_rear_right_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                  ) {
                    translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                      cylinder(d=multipcb_top_standoff[4] - .2, h=floorthick + (2 * adj));
                  }
                  if (
                    pcbclass == "pcbhole" && pcbhole_pos == "right_front" && multipcb_top_front_right_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                  ) {
                    translate([pcbhole_x, pcbhole_y, case_z - (floorthick + adj)])
                      cylinder(d=multipcb_top_standoff[4] - .2, h=floorthick + (2 * adj));
                  }
        ...
        if (ext_top_standoffs == true) {
          ...
          if (
            (
              width - pcb_loc_x - pcb_width - (gap + 2 * wallthick) >= ext_top_standoff_support_size || pcb_loc_y >= ext_top_standoff_support_size
            ) && ext_top_rear_right_enable == true && ext_top_standoff[6] != "blind"
          ) {
            translate(
              [
                width - ext_top_standoff_support_size / 2.5 - (2 * (wallthick + gap)),
                ext_top_standoff_support_size / 2.5,
                case_z - (floorthick + adj),
              ]
            )
          ...
          if (
            (
              (
                width - pcb_loc_x - pcb_width - (gap + 2 * wallthick) >= ext_top_standoff_support_size && depth - pcb_loc_y - pcb_depth >= ext_top_standoff_support_size
              ) || (
                width - pcb_loc_x - pcb_width - (gap + 2 * wallthick) >= ext_top_standoff_support_size && depth - pcb_loc_y - pcb_depth <= ext_top_standoff_support_size
              ) || (
                width - pcb_loc_x - pcb_width - (gap + 2 * wallthick) <= ext_top_standoff_support_size && depth - pcb_loc_y - pcb_depth >= ext_top_standoff_support_size
            ...
            translate(
              [
                width - ext_top_standoff_support_size / 2.5 - (2 * (wallthick + gap)),
                depth - ext_top_standoff_support_size / 2.5 - (2 * (wallthick + gap)),
                case_z - (floorthick + adj),
              ]
            )
              cylinder(d=ext_top_standoff[4] - .2, h=floorthick + (2 * adj));
          ...
          // left-rear standoff
          if (
            (pcb_loc_x >= ext_top_standoff_support_size || pcb_loc_y >= ext_top_standoff_support_size) && ext_top_rear_left_enable == true && ext_top_standoff[6] != "blind"
          ) {
          ...
          if (
            (
              (
                pcb_loc_x >= ext_top_standoff_support_size && (depth - (pcb_loc_y + pcb_depth)) >= ext_top_standoff_support_size
              ) || (
                pcb_loc_x <= ext_top_standoff_support_size && (depth - (pcb_loc_y + pcb_depth)) >= ext_top_standoff_support_size
              ) || (
                pcb_loc_x >= ext_top_standoff_support_size && (depth - (pcb_loc_y + pcb_depth)) <= ext_top_standoff_support_size
      ...
      if (sbc_top_standoffs == true) {
        for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
          ...
          case_z =
            ...
            : case_design == "panel_nas" ? case_z - floorthick : case_z;
          stand_off_adj =
            case_design == "fitted" || case_design == "tray_sides" || case_design == "tray_vu5" || case_design == "tray_vu7" ? floorthick
            : case_design == "snap" ? 2 * floorthick : 0;

          if (
            class == "pcbhole" && id == pcb_id && (
          ...
          if (class == "pcb") {
            for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
              ...
              if (pcbclass == "pcbhole" && pcbid == id && id != 0) {
                if (
                  pcbhole_pos == "left_rear" && multipcb_top_rear_left_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                ) {
                  top_support = multipcb_top_sidewall_support == true ? multipcb_top_rear_left_support : "none";
                  pcb_standoff = [
                    multipcb_top_standoff[0],
                ...
                if (
                  pcbhole_pos == "left_front" && multipcb_top_front_left_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                ) {
                ...
                if (
                  pcbhole_pos == "right_rear" && multipcb_top_rear_right_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                ) {
                ...
                if (
                  pcbhole_pos == "right_front" && multipcb_top_front_right_enable == true && (pcbhole_state == "top" || pcbhole_state == "both")
                ) {
      ...
      if (ext_top_standoffs == true) {
        ...
        if (
          (pcb_loc_x >= ext_top_standoff_support_size || pcb_loc_y >= ext_top_standoff_support_size) && ext_top_rear_left_enable == true
        ) {
          extended_standoff = [
            ext_top_standoff[0],
            ext_top_standoff[1],
      ...
      for (i = [1:11:len(accessory_data[a[0]]) - 1]) {
        ...
        if ( (class == "sub" && face == "top") || class == "suball") {
          if (accessory_highlight == false) {
            parametric_move_sub(
              type, loc_x, loc_y, loc_z, face, rotation,
      ...
      for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
        ...
        if (class == "pcb") {
          for (i = [1:11:len(sbc_data[s[0]]) - 2]) {
            ...
            if (id == pcbid) {
              indent(
                loc_x, loc_y, bottom_height + loc_z - adj, rotation[2],
    ...
    if (case_design == "shell") {
      translate(
        ...
        cube_negative_fillet(
          [width, depth, top_height], radius=-1,
          vertical=[corner_fillet, corner_fillet, corner_fillet, corner_fillet],
          top=[edge_fillet, edge_fillet, edge_fillet, edge_fillet, edge_fillet],
          bottom=[0, 0, 0, 0], $fn=90
        );
