...
// translate([32.7, -4, 4])
//   linear_extrude(h=14) square([17, 2]);

translate([0, -12, 0])
  union() {
    linear_extrude(h=4) circle(r=1.8);
    translate([0, 0, 0])
      linear_extrude(h=1.5) circle(r=2.8);
  }
;
...
//  "opizero", "opizero2", "opir1plus_lts", "opir1", "opi5", "opi5max", "opi3b-v2.1", "jetsonnano",
//  "lepotato", "sweetpotato", "tritium-h2+", "tritium-h3", "tritium-h5", "solitude", "alta", "atomicpi",
//  "visionfive2", "visionfive2q", "bpif3", "milk-v_duos", "licheerv+dock", "rak19007", "cnano-avr128da48",
//  "nodemcu-32s", "cs-solarmeter", "feather-m0_express", "feather-m0_wifi", "feather-m4_express",
...
// adjustment for ssi-eeb, ssi-ceb, atx, micro-atx, dtx, flex-atx, mini-dtx, mini-itx, mini-stx, nano-itx,nuc, pico-itx
// PCB thickness from 2mm default//
...
// bay sbc device
Rack_Bay1 =
"none"; //  ["none", "c1+", "c2", "c4", "hc4", "c5", "xu4", "xu4q", "mc1", "hc1", "n1", "n2", "n2+", "n2l", "n2lq",
//  "m1", "m1s", "m2", "h2", "h2+", "h3", "h3+", "h4", "h4+", "h4_ultra", "show2", "rpipico", "rpipicow",
//  "rpicm4+ioboard", "rpicm1", "rpicm3", "rpicm3l", "rpicm3+", "rpicm4s", "rpicm4", "rpicm4l", "rpizero",
//  "rpizerow", "rpizero2w", "rpi1a+", "rpi1b+", "rpi2b", "rpi3a+", "rpi3b", "rpi3b+", "rpi4b", "rpi5",
//  "a64", "a64lts", "rock64", "rockpro64", "quartz64a", "quartz64b", "h64b", "star64",
//  "soedge_a-baseboard", "soedge_rk1808", "rock4a", "rock4b", "rock4a+", "rock4b+", "rock4c", "rock4c+",
...
bottom_cover_pattern = "hex_8mm"; //[solid,hex_5mm,hex_8mm,linear_vertical,linear_horizontal,astroid]
// heatsink opening
cooling = "vent_hex_8mm"; // [default,none,open,fan_open,fan_1,fan_2,fan_hex,vent,vent_hex_5mm,vent_hex_8mm,custom]
...
// uart opening
uart_opening = "none"; // [default,none,open,knockout]
...
// "n-series_rack19-1u", "n1_rack10-1u", "m2_shell", "m2_eyespi_eink1.54", "m2_eyespi_lcd2.8",
// "m1s_shell_nvme", "m1s_shell_ups", "m1s_tray_nvme", "m1_tray_ssd", "m1_fitted_pizzabox2.5",
// "m1_fitted_pizzabox3.5", "h3_shell", "h3_shell_router", "h3_lowboy", "h3_lowboy_router",
// "h3_panel_nas", "h3_ultimate", "h3_ultimate2", "h4_panel_nas", "h4_rack_nas", "show2_shell",
// "rpi5_m2hat", "rpi5_bottom_m2hat", "rock5b", "adapter_mini-stx_m1s", "nas", "cs_solarmeter",
// "n2l_env_sensors", "avr_env_sensors", "env_sensors", "adafruit_solar_charger"]
...
top_standoff_support_size = 7; //[0:.01:25]
...
ext_top_standoff_pillar = "round"; //[hex, round]
...
multipcb_top_standoff_size =
"m2.5"; //[m2_tap, m2, m2+, m2.5_tap, m2.5, m2.5+, m3_tap, m3, m3+, m4_tap, m4, m4+, custom]
multipcb_top_standoff_type = "blind"; //[none, countersunk, recessed, nut holder, blind]
multipcb_top_standoff_pillar = "round"; //[hex, round]
...
ext_bottom_standoff_type = "none"; //[none, countersunk, recessed, nut holder, blind]
ext_bottom_standoff_pillar = "round"; //[hex, round]
...
multipcb_bottom_standoff_size =
"m2.5"; //[m2_tap, m2, m2+, m2.5_tap, m2.5, m2.5+, m3_tap, m3, m3+, m4_tap, m4, m4+, custom]
multipcb_bottom_standoff_type = "none"; //[none, countersunk, recessed, nut holder, blind]
multipcb_bottom_standoff_pillar = "round"; //[hex, round]
...
pcb_z =
  sbc_model == "ssi-eeb" || sbc_model == "ssi-ceb" || sbc_model == "atx" || sbc_model == "micro-atx" || sbc_model == "dtx" || sbc_model == "flex-atx" || sbc_model == "mini-dtx" || sbc_model == "mini-itx" || sbc_model == "mini-itx_thin" || sbc_model == "mini-stx" || sbc_model == "mini-stx_thin" || sbc_model == "nano-itx" || sbc_model == "nuc" || sbc_model == "pico-itx" ? pcb_z_orig + standard_motherboard_thickness
  : pcb_z_orig;
width =
  case_design == "panel_nas" && pcb_width <= 100 ? pcb_width + 2 * (sidethick + gap) + case_offset_x + (101.6 - pcb_width)
  : case_design == "panel_nas" && pcb_width > 100 ? pcb_width + 2 * (sidethick + gap) + case_offset_x
  : case_design == "rack" && rack_width == 19 ? 450
  : case_design == "rack" && rack_width == 10 ? 221.5
  : pcb_width + (2 * (wallthick + gap)) + case_offset_x;
depth =
  case_design == "panel_nas" ? pcb_depth + 2 * (wallthick + gap) + case_offset_y + 147 - pcb_depth + hd_y_position
  : case_design == "rack" ? 100 + case_offset_y
  : pcb_depth + 2 * (wallthick + gap) + case_offset_y;
top_height = pcb_tmaxz + floorthick + case_offset_tz + pcb_loc_z;
bottom_height =
  (case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") ? pcb_z + pcb_bmaxz + floorthick + case_offset_bz + 4
  : pcb_z + pcb_bmaxz + floorthick + case_offset_bz;
case_z =
  case_design == "panel_nas" ? bottom_height + top_height + hd_z_position + (hd_bays * (hd_space + 26.1))
  : case_design == "rack" && rack_size == "1u" ? 44.45 + floorthick
  : case_design == "rack" && rack_size == "1u+" ? 59.26 + floorthick
  : case_design == "rack" && rack_size == "1u++" ? 74.07 + floorthick
  : case_design == "rack" && rack_size == "2u" ? 88.90 + floorthick
...
hd_spacer =
  case_design == "panel_nas" && pcb_width > 100 ? (pcb_width + case_offset_x + 2 * gap) - 101.6
  : case_design == "panel_nas" && pcb_width <= 100 ? (width - 2 * (sidethick + gap) - 101.6)
  : 0;
...
rack_bay_xyz_loc = [
  [rack_bay1_xyz_loc[0], rack_bay1_xyz_loc[1], rack_bay1_xyz_loc[2]],
...
rack_bay_rear_conduit = [
  rack_bay1_rear_conduit,
  rack_bay2_rear_conduit,
  rack_bay3_rear_conduit,
  rack_bay4_rear_conduit,
  rack_bay5_rear_conduit,
  rack_bay6_rear_conduit,
];
baysize = (450 - (2 * wallthick)) / 6;
bay_height =
  rack_size == "1u" ? 44.45 - floorthick
  : rack_size == "1u+" ? (44.45 / 3) + 44.45 - floorthick
  : rack_size == "1u++" ? 2 * (44.45 / 3) + 44.45 - floorthick
  : (2 * 44.45) - floorthick;
...
if (view == "platter") {
  if (case_design == "shell") {
    ...
    translate([0, (2 * depth) + 20, case_z])
      rotate([180, 0, 0])
        case_top(case_design);
  }
  if (case_design == "panel" || case_design == "panel_nas") {
    case_bottom(case_design);
    translate([0, (2 * depth) + 5, case_z])
      rotate([180, 0, 0])
        case_top(case_design);
    translate([width + 25, 0, -gap])
      rotate([-90, 0, 0])
        case_side(case_design, "rear");
    translate([width + 25, 2 * (case_z) + 10, -depth + wallthick + gap + floorthick])
      rotate([90, 0, 0])
        case_side(case_design, "front");
    translate([2.5 * width, 0, -width + (3 * sidethick) + gap])
      rotate([0, -90, -90])
  ...
  if (case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
    case_bottom(case_design);
    translate([0, (2 * depth) + 10, case_z])
      rotate([180, 0, 0])
        case_top(case_design);
    if (case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
      translate([3.5 * width, 0, width])
        rotate([0, 90, 90])
          case_side(case_design, "right");
      translate([width + 15, 0, 2 * sidethick])
        rotate([0, -90, -90])
          case_side(case_design, "left");
    }
  }
  if (case_design == "round") {
    case_bottom(case_design);
    translate([width + 30, depth, case_z - floorthick - gap])
      rotate([180, 0, 0])
        case_top(case_design);
  }
  if (case_design == "hex") {
    case_bottom(case_design);
    translate([2 * width, depth, case_z])
      rotate([180, 0, 0])
        case_top(case_design);
  }
  if (case_design == "snap") {
    case_bottom(case_design);
    translate([0, (2 * depth) + 20, case_z + 2 * floorthick])
      rotate([180, 0, 0])
        case_top(case_design);
  }
  if (case_design == "fitted") {
    case_bottom(case_design);
    translate([0, (2 * depth) + 20, case_z + floorthick])
      rotate([180, 0, 0])
        case_top(case_design);
  }
  if (case_design == "rack") {
    ...
    for (r = [0:ucount - 1]) {
      ...
      if (rack_bay_rear_fan[r] == true) {
        translate(
          [-gap - wallthick - 1 + .125 + 75 * (r + 1) + fan_offset + 8, -80, (case_z - rear_fan_size) / 2]
        )
        ...
        translate([0, -50, 0])
          rotate([270, 0, 0])
            difference() {
              ...
              translate([-gap - wallthick - 1 + .125 + 75 * (r + 1) + grommet_offset - 10, -.125, -3])
                cube([20, 10, 20]);
            }
        translate([0, -30, 0])
          rotate([270, 0, 0])
  ...
  if (accessory_name != "none") {
    for (i = [1:11:len(accessory_data[a[0]]) - 1]) {
      ...
      if (class == "platter" && type != "button_assembly") {
        add(
          type, loc_x, loc_y, loc_z, face, rotation, [size_x, size_y, size_z],
          [data_1, data_2, data_3, data_4], mask
        );
      }
      if (class == "platter" && type == "button_assembly") {
        translate([loc_x, loc_y, loc_z + 1.25])
          rotate([-90, 0, 0])
            button_plunger(data_1, size_x, size_z);
        translate([loc_x - 20, loc_y - 10, loc_z + 3])
          rotate([0, 0, 0])
            button_top(data_1, size_x, size_z);
        translate([loc_x - 20, loc_y - 20, loc_z])
          rotate([0, 0, 0])
            button_clip(data_1);
      }
      if (class == "platter" && type == "h3_port_extender_holder") {
        translate([loc_x, loc_y, loc_z])
          rotate([0, 0, 0])
            h3_port_extender_holder("bottom");
        translate([loc_x - 20, loc_y + 40, loc_z + 36.5])
          rotate([180, 0, 0])
            h3_port_extender_holder("top");
      }
    }
  }
...
if (view == "model") {
  ...
  if (case_design == "shell") {
    if (lower_bottom >= 0) {
      difference() {
        color("dimgrey", 1) translate([0, 0, -lower_bottom])
            case_bottom(case_design);
        if (move_rear < 0) {
    ...
    if (raise_top >= 0) {
      difference() {
        color("grey", 1) translate([0, 0, raise_top])
            case_top(case_design);
        if (move_rear < 0) {
          translate([-gap - wallthick - 1, -gap - wallthick - 1, -lower_bottom - 1])
            cube([width + 2, gap + wallthick + 1.01, case_z + 2]);
  ...
  if (case_design == "panel") {
    ...
    if (move_front >= 0) {
      color("grey", 1) translate([0, move_front, 0])
          case_side(case_design, "front");
    }
    if (move_rear >= 0) {
      color("grey", 1) translate([0, -move_rear, 0])
          case_side(case_design, "rear");
    }
    if (move_rightside >= 0) {
      color("grey", 1) translate([move_rightside, 0, 0])
          case_side(case_design, "right");
    }
    if (move_leftside >= 0) {
      color("grey", 1) translate([-move_leftside, 0, 0])
          case_side(case_design, "left");
    }
    if (sbc_off == false) {
      translate([pcb_loc_x, pcb_loc_y, bottom_height - pcb_z + pcb_loc_z])
  ...
  if (case_design == "panel_nas") {
    if (lower_bottom >= 0) {
      color("grey", 1) translate([0, 0, -lower_bottom])
          case_bottom(case_design);
    }
    if (raise_top >= 0) {
      color("grey", 1) translate([0, 0, raise_top])
    ...
    if (move_rightside >= 0) {
      color("dimgrey", 1) translate([move_rightside, 0, 0])
          case_side(case_design, "right");
    }
    if (move_leftside >= 0) {
      color("dimgrey", 1) translate([-move_leftside, 0, 0])
          case_side(case_design, "left");
    }
      ...
      if (hd_reverse == false) {
        ...
        if (hd_center == true) {
          ...
          if (pcb_width > 100 || width - 2 * (sidethick + gap) > 101.6) {
            ...
            translate(
              [
                -(hd_spacer / 2 - 9.4) - gap + hd_spacer / 2,
                28.5 - (3 * wallthick) - gap + hd_y_position + 101.6,
                hd_z_position + 6.5 + (hd_space + 27.1) * i,
              ]
            )
    ...
    if (move_rear >= 0) {
      fan_model =
        rear_fan_size == 92 ? "box92x10"
        : rear_fan_size == 80 ? "box80x10"
        : rear_fan_size == 60 ? "box60x10"
        : "box40x10";
      if (rear_fan == 1 || rear_fan == 2) {
        ...
        if (rear_fan_center == true) {
          translate(
            [
              -1 + (101.6 - rear_fan_size) / 2 + (width - 2 * (sidethick + gap) - 101.6) / 2,
              10 - wallthick,
              rear_fan_position,
            ]
          )
  ...
  if (case_design == "tray" || case_design == "tray_sides" || case_design == "tray_vu5" || case_design == "tray_vu7") {
    ...
    if (case_design == "tray_vu5") {
      color("darkgrey", .5)
        translate([width + ( (127.5 - width) / 2) - 6.5 - wallthick - gap, depth - 1, case_z + 15.5])
          rotate([-15, 0, 180])
            import(file="stl/Vu5a_Case.stl");
      // right speaker and bracket
      color("darkgrey", .5)
        translate([( (127.5 - 75) / 2) + (width / 2) - wallthick - gap + 30.5, depth - 1, case_z + 15])
          rotate([75, 0, 180])
            import(file="stl/Vu5_Speaker_Bracket_Left.stl");
      color("darkgrey", .5)
        translate([( (127.5 - 75) / 2) + (width / 2) - wallthick - gap + 85, depth + 15, case_z + 12.5])
          rotate([-15, 0, 180])
            hk_speaker();
      ...
      color("darkgrey", .5)
        translate([-( (127.5 - 75) / 2) + (width / 2) - wallthick - gap - 40.5, depth + 15, case_z + 12.5])
          rotate([-15, 0, 180])
            hk_speaker();
    }
    if (case_design == "tray_vu7") {
      color("darkgrey", .5)
        translate([width + ( (192.90 - width) / 2) - wallthick - gap - 20, depth - 1, case_z + 15.5])
          rotate([-15, 0, 180])
            import(file="stl/Vu7a_Case.stl");
      // right speaker and bracket
      color("darkgrey", .5)
        translate([( (192.90 - 100) / 2) + (width / 2) - wallthick - gap + 57.5, depth - 4, case_z + 27])
          rotate([75, 0, 180])
            import(file="stl/Vu7_Speaker_Bracket_Left.stl");
      color("darkgrey", .5)
        translate([( (192.90 - 100) / 2) + (width / 2) - wallthick - gap + 97, depth + 11.5, case_z + 27])
          rotate([-15, 0, 180])
            hk_speaker();
      // left speaker and bracket
      color("darkgrey", .5)
        translate([-( (192.90 - 100) / 2) + (width / 2) - wallthick - gap - 58, depth - 4, case_z + 27])
          rotate([75, 0, 180])
            import(file="stl/Vu7_Speaker_Bracket_Right.stl");
      color("darkgrey", .5)
        translate([-( (192.90 - 100) / 2) + (width / 2) - wallthick - gap - 53.5, depth + 11.5, case_z + 27])
          rotate([-15, 0, 180])
            hk_speaker();
    }
    if (sbc_off == false) {
  ...
  if (case_design == "rack") {
    ...
    if (raise_top >= 0) {
      difference() {
        color("dimgrey", 1) translate([0, 0, raise_top])
            case_rack(case_design, "top");
        if (move_rear < 0) {
          translate([-gap - wallthick - 1, -gap - wallthick - 1, -lower_bottom - 1])
            cube([width + 2, gap + wallthick + 1.01, case_z + 2]);
    ...
    for (r = [0:ucount]) {
      ...
      if (rack_bay_rear_fan[r] == true) {
        translate(
          [
            -gap - wallthick - 1 + .125 + 75 * (r + 1) + fan_offset + 8,
            depth - gap,
            (case_z - rear_fan_size) / 2,
          ]
        )
          rotate([90, 0, 0])
            fan_cover(rear_fan_size, wallthick, rear_cooling);
      ...
      if (rack_bay_rear_conduit[r] == "grommet" || rack_bay_rear_conduit[r] == "grommets-vertical") {
        translate(
          [-gap - wallthick - 1 + .125 + 75 * (r + 1) + grommet_offset + 4, depth - wallthick - gap, 13]
        )
          color("lightgrey") grommet("front", "sleeve", 10, 4, wallthick, true, [false, 10, 0, "default"]);
      }
      if (rack_bay_rear_conduit[r] == "grommets-vertical") {
        translate(
          [-gap - wallthick - 1 + .125 + 75 * (r + 1) + grommet_offset + 4, depth - wallthick - gap, 30]
        )
          color("lightgrey") grommet("front", "sleeve", 10, 4, wallthick, true, [false, 10, 0, "default"]);
      }
    ...
    if (sbc_off == false) {
      for (i = [0:len(rack_bay_sbc) - 1]) {
        if (rack_bay_sbc[i] != "none" && rack_bay_face[i] != "removable") {
          ...
          pcb_loc_x =
            rack_bay_rotation[i] == 90 ? rack_bay_xyz_loc[i][0] + pcb_width
            : rack_bay_rotation[i] == 180 ? rack_bay_xyz_loc[i][0] + pcb_width
            : rack_bay_xyz_loc[i][0];
          pcb_loc_y =
            rack_bay_rotation[i] == 270 ? rack_bay_xyz_loc[i][1] + pcb_width
        ...
        if (rack_bay_sbc[i] != "none" && rack_bay_face[i] == "removable") {
          ...
          translate(
            [
              pcb_loc_x + bayadj + 75 * (i + 1),
              pcb_loc_y + wallthick + gap,
              pcb_bmaxz + floorthick + case_offset_bz + pcb_loc_z + 1,
            ]
          )
            rotate([0, 0, rack_bay_rotation[i]])
              sbc(rack_bay_sbc[i], cooling, fan_size, gpio_opening, uart_opening, false);
  ...
  if (
    ...
    if (case_design == "adapter_mini-stx_thin" || case_design == "adapter_mini-stx") {
      color("dimgrey", 1) translate([-1.2, -4.5, -2])
          io_shield();
    } else {
      color("dimgrey", 1) translate([-10.79, -4.5, -2])
          io_shield();
    }
  }
  // ui access panel
  if (bottom_access_panel_enable == true) {
    if (access_panel_rotation == 0) {
      translate([access_panel_location[0], access_panel_location[1], 0])
        rotate([0, 0, access_panel_rotation])
          color("grey", 1)
            access_cover([access_panel_size[0], access_panel_size[1], floorthick], access_panel_orientation);
    }
    ...
    if (access_panel_rotation == 180) {
      translate(
        [access_panel_location[0] + access_panel_size[0], access_panel_location[1] + access_panel_size[1], 0]
      )
        rotate([0, 0, access_panel_rotation])
          color("grey", 1)
            access_cover([access_panel_size[0], access_panel_size[1], floorthick], access_panel_orientation);
  ...
  if (accessory_name != "none") {
    for (i = [1:11:len(accessory_data[a[0]]) - 1]) {
      ...
      if (class == "model" && face == "top" && raise_top > -1) {
        parametric_move_add(
          type, loc_x, loc_y, loc_z + raise_top, face, rotation, parametric, size, data,
          [false, mask[1], mask[2], mask[3]]
        );
      } else {
        if (class == "model" && face != "top") {
          parametric_move_add(
            type, loc_x, loc_y, loc_z, face, rotation, parametric, size, data,
            [false, mask[1], mask[2], mask[3]]
          );
        }
      }
  ...
  if (sbc_information == true) {
    for (i = [0:1:len(sbc_data[s[0]][1]) - 1]) {
      color(text_color) translate([text_offset + text_indent[i], depth, (text_height - i * 7) + raise_top])
          rotate([90, 0, 0])
            text(str(sbc_data[s[0]][1][i]), 5, font=text_font);
    }
  }
}
//}
...
if (view == "part") {
  if (individual_part == "top") {
    ...
    if (case_design == "panel" || case_design == "panel_nas") {
      if (section_part == false) {
        ...
        projection() translate([0, depth, case_z])
            rotate([180, 0, 0])
              case_top(case_design);
      }
    }
    ...
    if (
      case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides"
    ) {
      translate([0, depth, case_z])
        rotate([180, 0, 0])
          case_top(case_design);
    ...
    if (case_design == "snap") {
      translate([0, depth, case_z + 2 * floorthick])
        rotate([180, 0, 0])
          case_top(case_design);
    }
    if (case_design == "fitted") {
      translate([0, depth, case_z + floorthick])
        rotate([180, 0, 0])
          case_top(case_design);
    }
  }
  if (individual_part == "bottom") {
    if (
      case_design == "shell" || case_design == "stacked" || case_design == "round" || case_design == "hex" || case_design == "round" || case_design == "snap" || case_design == "fitted"
    ) {
      case_bottom(case_design);
    }
    if (
    ...
    if (case_design == "rack") {
      difference() {
        translate([-150, 0, -lower_bottom])
          case_rack(case_design, "bottom");
        translate([-gap - wallthick - 450, -gap - wallthick - 1, -adj])
          cube([450, depth + 2, case_z + 2 * adj]);
        translate([150 - gap - wallthick, -gap - wallthick - 1, -adj])
          cube([450, depth + 2, case_z + 2 * adj]);
      }
    }
    if (case_design == "panel" || case_design == "panel_nas") {
  ...
  if (individual_part == "right") {
    if (case_design == "panel" || case_design == "panel_nas") {
      if (section_part == false) {
        translate([gap, 0, -width + (2 * wallthick) + gap])
          rotate([0, -90, -90])
            case_side(case_design, "right");
      } else {
        projection() translate([gap, 0, -width + (2 * wallthick) + gap])
            rotate([0, -90, -90])
              case_side(case_design, "right");
      }
    }
    if (case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
      translate([depth, 0, width - gap])
        rotate([0, 90, 90])
          case_side(case_design, "right");
    }
    if (case_design == "rack" && rack_width == 19) {
      difference() {
        translate([-300, 0, -lower_bottom])
          case_rack(case_design, "bottom");
        translate([-gap - wallthick - 450, -gap - wallthick - 1, -adj])
          cube([450, depth + 2, case_z + 2 * adj]);
      }
  ...
  if (individual_part == "left") {
    if (case_design == "panel" || case_design == "panel_nas") {
      if (section_part == false) {
        translate([depth, 0, -gap])
          rotate([0, 90, 90])
            case_side(case_design, "left");
      } else {
        projection() translate([depth, 0, -gap])
            rotate([0, 90, 90])
              case_side(case_design, "left");
      }
    }
    if (case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
      translate([gap, 0, 2 * sidethick + gap])
        rotate([0, -90, -90])
          case_side(case_design, "left");
    }
    if (case_design == "rack") {
      difference() {
        translate([0, 0, -lower_bottom])
          case_rack(case_design, "bottom");
        translate([150 - gap - wallthick, -gap - wallthick - 1, -adj])
          cube([450, depth + 2, case_z + 2 * adj]);
      }
  ...
  if (individual_part == "accessories") {
    ...
    if (bottom_access_panel_enable == true) {
      ...
      if (access_panel_rotation == 180) {
        translate(
          [
            access_panel_location[0] + access_panel_size[0],
            -access_panel_location[1] + access_panel_size[1],
            0,
          ]
        )
          rotate([0, 0, access_panel_rotation])
...
if (case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides") {
  ...
  if (case_design == "panel_nas") {
    echo(
      width=width + hd_spacer, depth=depth, top=top_height, bottom=bottom_height,
      height=case_z + (3 * wallthick)
    );
